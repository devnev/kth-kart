...
public class OrderUpdate {
  ...
  public static class Order {
    ...
    public static Order MoveOrder(Vector vector) {
      Vector valid = vector.truncateToValid();
      return MoveOrder(valid.x, valid.y);
    }

    public static Order MoveOrder(Entity entity) {
      return MoveOrder(entity.getXPos(), entity.getYPos());
    }
    ...
    public static Order FireOrder(Entity entity) {
      return FireOrder(entity.getId());
    }
